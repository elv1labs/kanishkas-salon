...
export default function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-10 scale-125" />

            {/* Main button */}
            <span className="relative flex w-14 h-14 items-center justify-center bg-[#25D366] rounded-full shadow-lg shadow-[#25D366]/40 hover:scale-110 active:scale-95 transition-transform duration-200">
                <svg
